    ...
    <tr>
      <td width="45%">
        <div align="center" style="background:#1e1e1e; padding:20px; border-radius:10px; color:white;">
          ...
          <img src="https://github.com/user-attachments/assets/fabac975-af35-44e0-a76b-5a4e5df479bd" width="100%" style="border-radius:10px;" alt="Exxen Project" />
          <br><br>
      ...
      <td width="45%">
        <div align="center" style="background:#1e1e1e; padding:20px; border-radius:10px; color:white;">
          ...
          <img src="https://github.com/user-attachments/assets/48f846b8-5f45-4135-9312-d049d7fcebea" width="100%" style="border-radius:10px;" alt="Object Tracking" />
          <br><br>
