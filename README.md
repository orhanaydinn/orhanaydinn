...
|:--------------------------------------|:----------------------------------------|:----------------------------------------|
|**[oax_humanoid_robot](https://github.com/orhanaydinn/oax_humanoid_robot)** <br> <br> <br> An LLM-enabled humanoid robot that uses vision, natural language commands, JSON tool calling, and Planner/Controller validation to perform object search, tracking, pick attempts, and basic human-robot interaction. The project focuses on connecting perception, LLM reasoning, robot state, and safe physical execution in a modular humanoid robot pipeline. | Python - PyTorch - Hugging Face Transformers - LoRA/PEFT - OpenCV - YOLO - OAK-D Lite - DepthAI - JSON Tool Calling - IK/FK Motion Planning - Arduino - Serial Communication - Stepper Motors - Servo Motors - 3D Printing - SolidWorks | <img src="https://github.com/user-attachments/assets/16559723-622d-4e29-a526-c7c63d6322f6" width="350" height="200" alt="Exxen Project" /> |
