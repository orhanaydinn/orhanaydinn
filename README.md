...
|:--------------------------------------|:----------------------------------------|:----------------------------------------|
|**[Multimodal RAG AI Assistant](https://github.com/orhanaydinn/qa_assistant)** <br> <br> <br>  This project is a multimodal AI assistant that combines Retrieval-Augmented Generation (RAG), OCR, and large language models to answer questions using PDFs, images, and web data. It extracts and embeds content with FAISS for semantic retrieval, enabling context-aware responses grounded in user-provided documents and visual inputs. The system also integrates image generation capabilities and a Streamlit-based interface for interactive querying. This project demonstrates practical implementation of multimodal AI pipelines, vector search, and LLM-driven applications. | Python - Streamlit - FAISS - Retrieval Augmented Generation (RAG) - LangChain - Hugging Face Transformers - sentence-transformers - Vector Databases - Semantic Search - EasyOCR - PDF Processing - Multimodal AI - Stable Diffusion - Large Language Models (LLM) | <img src="https://github.com/user-attachments/assets/0209eb0a-aac3-4ebc-b4b1-3677446c2e64" width="350" height="200" alt="CNN" /> |
...
|**[Exxen Project](https://github.com/orhanaydinn/Exxen_project.git)** <br> <br> <br> Example for digital streaming platform which is included 2 different languages in interface. | HTML - CSS | <img src="https://github.com/user-attachments/assets/fabac975-af35-44e0-a76b-5a4e5df479bd" width="350" height="200" alt="Exxen Project" /> |
