...
|:--------------------------------------|:----------------------------------------|:----------------------------------------|
|**[Hand Sign Classifier](https://github.com/orhanaydinn/sign_language_Project.git)** <br> <br> <br>  The system utilizes deep neural networks to classify sign language numbers (0–9) from hand gesture images. It compares multiple models—including a custom CNN, VGG16, ResNet50, and MobileNetV2—using training accuracy, validation performance, and fine-tuning strategies for optimal recognition. The project highlights the effectiveness of transfer learning in gesture classification tasks. |Python - PyTorch - OpenCV - MediaPipe - Deep Learning - CNN - Transfer Learning - VGG16 - ResNet50 - MobileNetV2 - Jupyter Notebook | <img src="https://github.com/user-attachments/assets/15d60c0b-1dbc-4569-9e6c-127ed1736107" width="350" height="200" alt="CNN" /> |
